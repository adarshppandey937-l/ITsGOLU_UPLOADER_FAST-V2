...
photologo = 'https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photoyt = 'https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png' #https://i.ibb.co/v6Vr7HCt/1000003297.png
photocp = 'https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png'
photozip = 'https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+5sVMWnGxTBoyNzM1")        ],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png",
    "https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png",
    "https://i.postimg.cc/XJYGNXHk/IMG-20260205-235350.png",
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    photo=photologo,
                    caption="**Mʏ Nᴀᴍᴇ [DRM ](https://t.me/+5sVMWnGxTBoyNzM1)\n\nYᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ\nCᴏɴᴛᴀᴄᴛ [𝐈𝐓'𝐬𝐆𝐎𝐋𝐔.™®](https://t.me/ITsGOLU_OWNER_BOT) ғᴏʀ ᴀᴄᴄᴇꜱꜱ**",
                    reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("ₚₐₙdₑyⱼi up43.™®", url="https://t.me/+5sVMWnGxTBoyNzM1")
    ],
    [
        ...
        InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", callback_data="details")
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("ₚₐₙdₑyⱼi up43.™®", url="https://t.me/MAHADEV_SAVE1_BOT")
    ],
    [
        InlineKeyboardButton("ғᴇᴀᴛᴜʀᴇꜱ 🪔", callback_data="features"),
        InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", callback_data="details")
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        "<b>Mʏ Nᴀᴍᴇ [DRM Wɪᴢᴀʀᴅ 🦋](https://t.me/MAHADEV_SAVE1_BOT)</b>\n\n"
        "<blockquote>You need to have an active subscription to use this bot.\n"
        "Please contact admin to get premium access.</blockquote>",
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/MAHADEV_SAVE1_BOT")
        ]])
    )
...
async def txt_handler(bot: Client, m: Message):  
    ...
    (
        ...
        "<i>ᴇxᴛʀᴀᴄᴛᴇᴅ ʙʏ PANDEY JI ʙᴏᴛꜱ 🤖</i>"
    )
)
...
async def details_callback(client, callback_query: CallbackQuery):
    ...
    details_text = (
        "**📋 Bot Details 📋**\n\n"
        "• 🤖 Bot Name: drm bot \n"
        "• 👨‍💻 Developer: ₚₐₙdₑyⱼi up43\n"
        "• 📱 Contact: @mahadev_save1_bot\n"
        "• 🔄 Version: 1.0\n"
        "• 📝 Language: Python\n"
